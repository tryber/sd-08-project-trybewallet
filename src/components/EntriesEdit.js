...
class EntriesEdit extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(EntriesEdit);

EntriesEdit.propTypes = {
