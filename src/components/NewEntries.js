...
import {
  fetchCurrencies as takeCurrencies, getCurrencies, saveExpense as addExpense,
} from '../actions';
...
class NewEntries extends React.Component {
  constructor() {
    super();
...
const mapDispatchToProps = (dispatch) => ({
  fetchCurrencies: () => dispatch(takeCurrencies()),
